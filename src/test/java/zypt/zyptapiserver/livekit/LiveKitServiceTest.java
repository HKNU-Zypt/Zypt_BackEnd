...
//        LiveKitAccessTokenDTO createMyRoom = liveKitService.createRoom("1v", "1234", "myRoom", 10);
...
//        log.info("room = {}", myRoom);
    ...
    // 해당 테스트는 직접 방에 참여를 해야 반영되기에 의미없음
    @Test
...
//        Assertions.assertThat(myRoom1).isTrue();
    ...
    @DisplayName("방삭제 테스트")
    void deleteRoomNow()  {
//        LiveKitAccessTokenDTO myRoom = liveKitService.createRoom("1v", "1234", "myRoom", 10);
//
